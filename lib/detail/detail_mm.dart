...
class MMDetail extends StatelessWidget {
  @override
  ...
  Widget build(BuildContext context) {
    return Container(
      child: Column(
        children: <Widget>[
          Text(
              "Multimedia adalah suatu sarana atau media melalui penggunaan komputer dalam menggabungkan dan menyajikan suara, teks, , animasi, audio dan video dengan alat bantu dan koneksi sehingga pengguna dapat bernavigasi, berinteraksi, berkarya dan berkomunikasi. Multimedia sangat umum digunakan dalam dibidang informatika.",
              style: TextStyle(fontSize: 13.0)),
          Padding(
            padding: EdgeInsets.only(bottom: 10.0),
          ),
          Text(
              "Siswa yang lulus pada Kompetensi Keahlian Multimedia memiliki peluang yang besar untuk bekerja dan berwirausaha pada lingkup kerja/bidang usaha:",
              style: TextStyle(fontSize: 13.0)),
          Padding(
            padding: EdgeInsets.only(bottom: 10.0),
          ),
