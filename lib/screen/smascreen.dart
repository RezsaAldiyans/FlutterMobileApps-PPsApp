...
class HomeSma extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    Scaffold(
      appBar: AppBar(
        ...
        title: Text("SMA Prestasi Prima",style: TextStyle(color: Colors.white),),
                  ...
                  child: ListView(
                    ...
                    children: <Widget>[
                      ...
                      GestureDetector(
                        child: Container(
                          width: 300.0,
                          child: Image.asset("img/rpl-vector.jpeg"),
                        ),
                        onTap: () {
                          Navigator.push(
                              context,
                      ...
                      GestureDetector(
                        ...
                        onTap: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (BuildContext context) => MMDetail()));
                        },
                      ),
                      Padding(padding: EdgeInsets.only(right: 10.0)),
                      GestureDetector(
                      ...
                      GestureDetector(
                        ...
                        onTap: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (BuildContext context) => BCDetail()));
                        },
                      ),
                      Padding(padding: EdgeInsets.only(right: 10.0)),
                    ],
